...
const PasskeyModal=()=>{
 ...
 <AlertDialog open={open} onOpenChange={setOpen}>
  ...
  <AlertDialogContent className="shad-alert-dialog">
    <AlertDialogHeader>
      <AlertDialogTitle className="flex items-start justify-betwen">Admin access verification
        <Image 
    ...
    <AlertDialogFooter>
      ...
      <AlertDialogAction onClick={(e)=>validatePasskey(e)}
        className="shad-primary-btn w-full">Enter Admin paskey</AlertDialogAction>
    </AlertDialogFooter>
  </AlertDialogContent>
</AlertDialog>
